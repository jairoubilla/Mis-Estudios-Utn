...
.skills-contenedor {
    padding: 2rem;
    /* Usamos el gradiente de base o un color sólido del tema */
    /* background: linear-gradient(-45deg, #021526, #03346E, #6EACDA, #E2E2B6); <-- OLD */
    background-color: var(--color-background); /* Fondo negro principal */
}
...
.skills-categoria h3 {
    ...
    margin-bottom: 10px;
    font-size: 1.5em;
    color: var(--color-heading); /* Texto blanco para títulos */
    font-weight: bold;
}
...
.skill {
    ...
    align-items: center;
    gap: 10px;
    /* Fondo oscuro para las tarjetas de habilidad */
    background-color: var(--color-background-soft); 
    padding: 0.5em;
    border-radius: 8px;
    /* Sombra sutil o borde rojo */
...
.skill:hover {
    /* Al pasar el mouse, fondo rojo intenso y texto blanco */
...
.skill span {
    font-size: 1em;
    color: var(--color-text); /* Texto gris claro por defecto */
    transition: color 0.3s ease;
}

.skill:hover span {
    color: var(--palette-white); /* Texto blanco al hacer hover sobre fondo rojo */
}
