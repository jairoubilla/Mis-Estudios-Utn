...
### Abrimos la terminal de Git Bash en Windows o en la terminal de Ubuntu, tambien la terminal de Mac, y comenzamos con las siguientes comandos y creacion de directorios
<br/>

```sh
pwd # vemos la ruta ee la carpeta en la que estamos
cd # es para navegar a unsa carpeta: change directory -> cambiar de directorio
cd / # nos lleva al home, en la raiz del disco
cd ~ # la virgulilla significa que estamos en el lugar de los documentos o del usuario 
ls # esto es listar los archivos, nos  muestratodos los archivos en la raiz
la -al #el espacio -al significa que es un argumento especial para ver archivos ocultos
...
claer # limpia la consola o ctrl + l
cd .. # nos vuelve a la carpeta anterior
cd U + tab # esto se usa para un autocompletado o para buscar una referencia
cd /D # cambiamos al dis D: en windows
df -h # muesta todos los directorios en ubuntu
cd /mnt/d # cambia de directorio usando ESL Ubuntu en Windows
```
## AHORA COMENZAMOS CON LA CREACION DE CARPETAS
...
Abrir Git Bash en Windows o la terminal de Linuc o de Mac: al abrir Git Bash hacerlo como administrador
<br/>

```sh
touch vacio.txt # crea un archivo
ctrl + s # guardamos lo que escribimos en el archivo

./ # significa la carpta actual
...
rm --help # muestra la ayuda del comando
```
...
cd tecnicatura
mkir class-git
cd class-git # entramos en la carpeta que vamos a trabajar
git init # creamos un repositorio en la carpeta. Se crea el archivo .git
code . # abre el VSC
ctrl + n # crea un archivo nuevo
ctrl + s # graba el contenido del archivo
git status # vemos el estado del proyecto
git add historia.txt # enviamos el archivo al area de preparacion
git status # para ver el estado de los cambios
git rm --cached historia.txt # quitamos el archivo del area de preparacion 

git config # nos muestra como esta configurado git
git config --list # configuraciones importates
git config --list --show-origin # nos muestra donde estan las configuraciones guardadas

# configuramos nombre y direccion de correo
git config -global user.name "Alberto"
git config -global user.email "jacantarell@hotmail.com" # la direccion de correo debe ser la misma que usaremos en github
git config --list # ahora veremos que ya estan los datos completos

git add . # ingresamos todos los archivos al area de preparacion

git commit -m "mensaje del commit" 

code . # hacemos cambios en el archivo

git status # nos muestra que hay cambios para comitear
git add .
git commit -m "mi segundo commit" 

git log historia.txt # vemos toda la historia del archivo
```
...
rm ---recursive -rf Git # fuerza el borrado del directorio
...
git add .
git status
git commit -m "Creamos el archivo README.md dentro del directorio class-git"
git status
...
Para abror el README.md dsde VSC y ver los resultados usar el siguiente comando: <br/>
...
```sh
cd tecnicatura # ingresamos al directorio especificado
cd class-git # ingresamos al directorio especificado
ls # lista los archivos en el directorio actual
touch historia.txt # crea un archivo vacio
code . # llama al program VSC

# Modificamos el archivo historia.txt colocando lo siguiente: Bienvenido     mi nombre es Ariel (coloca tu nombre)

ctrl + s # graba las modificaciones en vsc
git status # nos dice el estado de los archivos en el repositorio
...
Entonces tenemos el área de trabajo, cuando colocamos: <br/>
git add historia.txt<br/>
pasamos al staging o área de preparación, que hay que recordar que esto es en la memoria ram y luego con <br/>
git commit -m "Mensaje"<br/>
pasa al repositorio en la rama master, allí se genera un nombre llenos de letras y números, es el hash, el nombre del commit.<br/>
...
cd tecnicatura # cambiamos al directorio especificado
cd class-git # cambiamos al directorio especificado
...
git diff  # nos muestra los cambios en memoria ram y en disco
...
git log #vemos lo nuevo que hemos hecho sin lo que borramos con el reset fuerte hacer cambios en historia.txt #Cambiamos la última línea y
ctrl + s 
git diff
...
# --------------------------------------------------------------------
# Clase 7 Miércoles - Portafolio 1
...
# --------------------------------------------------------------------
# Clase 8 Miércoles - Portafolio 2
...
# --------------------------------------------------------------------
# Clase 9-A Miércoles - Portafolio 3
...
# En VSC hacemos los cambios que veremos con Nico
...
# --------------------------------------------------------------------
# Clase 9-B Miércoles - Portafolio 4
...
# --------------------------------------------------------------------
# Clase 10-A Miércoles - Portafolio 5
...
# --------------------------------------------------------------------
# Clase 10-B Miércoles - Portafolio 6
...
# --------------------------------------------------------------------
# Clase 11 Miércoles - Portafolio 7
...
Revisar y ejecutar cada comando, hacerlo como practica: NO olvidar hacer lo requerido por el Tutor Nico, lo que sea tarea o investigación. Hoy les avisamos como hacemos para pasarles los formularios donde deben cargar los portafolios, un formulario es para el portafolio grupal, otro para el portafolio personal.

[Formulario portafolio Grupal](https://docs.google.com/forms/d/e/1FAIpQLSfVWwZpNECEYLfvh1ZPF3kZhioHP-j_08GSLUXWFKnN9l4I8g/viewform?pli=1)

[Formulario portafolio Personal](https://docs.google.com/forms/d/e/1FAIpQLSexFP8N41diqfHIwz_1RzTdDDfzS0qywjFftRtf6Oq-CB65iQ/viewform)
